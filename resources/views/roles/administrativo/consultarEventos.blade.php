            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @endif
                        @if(Auth::id() == $evento->user || auth()->user()->hasRole('CooAdmin') || auth()->user()->hasRole('AuxAdmin'))
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Manejador de envío para el formulario de actualización de estado de eventos
