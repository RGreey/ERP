...
<body>
@php
    $eventosHabilitados = $eventosHabilitados ?? true;
@endphp
                        ...
                        <div class="mb-md-4 mt-md-3 pb-4">
                            @if(!$eventosHabilitados)
                                <div class="alert alert-warning text-black">
                                    La creación de eventos está pausada temporalmente. Por favor, vuelve a intentarlo cuando el proceso administrativo se reactive.
                                </div>
                            @endif
                            ...
                            <div> 
                                ...
                                <button type="button" id="btnCrearEvento" class="btn btn-success" {{ $eventosHabilitados ? '' : 'disabled' }}>Crear Evento </i></button>
                            </form>
                        </div>
                    </div>
                </div>
...
<script>
    const eventosHabilitados = @json($eventosHabilitados);
...
<script>
    $(document).ready(function() {
        if (!eventosHabilitados) {
            $('#btnCrearEvento').text('Creación deshabilitada');
        }
        ...
        $('#btnCrearEvento').click(function() {
            if (!eventosHabilitados) {
                Swal.fire({
                    ...
                    text: 'Por ahora no se pueden crear eventos nuevos. Inténtalo cuando se reactive el servicio.'
                });
                return;
            }
