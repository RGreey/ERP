                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card h-100">
                                @if(Str::endsWith($evidencia->archivo_url, ['jpg','jpeg','png']))
                                    <img src="{{ asset('storages/' . $evidencia->archivo_url) }}" class="card-img-top" alt="Evidencia">
                                @else
                                    <a href="{{ asset('storages/' . $evidencia->archivo_url) }}" target="_blank" class="btn btn-outline-primary m-3">Ver archivo</a>
                                @endif
                                <div class="card-body">
