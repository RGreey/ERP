    ...
    class EventoController extends Controller
    {
        ...
        public function guardarEvento(Request $request)
        {
            ...
            try {
                ...
                $correoAdicional = 'administrativa.caicedonia@correounivalle.edu.co';
        ...
        //administrativa.caicedonia@correounivalle.edu.co
            ...
            try {
                ...
                if ($usuarioCreador) {
                    if ($evento->estado === 'Aceptado') {
                        ...
                        // Correos adicionales
                        $correosAdicionales = [ 'direccion.caicedonia@correounivalle.edu.co',
                                                'administrativa.caicedonia@correounivalle.edu.co',
                                                'julio.ceballos@correounivalle.edu.co',
                                                'rubiel.gutierrez@correounivalle.edu.co',
                                                'jhonnathan.ososrio@correounivalle.edu.co',
                                                'soporte.caicedonia@correounivalle.edu.co',
                                                'rodrigo.buitrago@correounivalle.edu.co',
                                                'maria.cairasco@correounivalle.edu.co',
                                                'grajales.maria@correounivalle.edu.co',
                                                'diana.moscoso@correounivalle.edu.co',
                                                'luz.estella.quintero@correounivalle.edu.co',
                                                'loaiza.jhon@correounivalle.edu.co',
                                                'comunicaciones.caicedonia@correounivalle.edu.co',
                                                'academica.caicedonia@correounivalle.edu.co'
                                                ];
        ...
        public function agregarAnotacion(Request $request)
        {
            try {
                ...
                $correosAdicionales = [ 'direccion.caicedonia@correounivalle.edu.co',
                                        ...
                                        'comunicaciones.caicedonia@correounivalle.edu.co',
                                        'academica.caicedonia@correounivalle.edu.co'
                                    ]; // Agrega más correos según necesites
