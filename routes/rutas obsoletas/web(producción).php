...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/monitoria/seguimiento/pdf/{monitor_id}/{mes}/{anio?}', [MonitoriaController::class, 'generarPDFSeguimiento'])->name('monitoria.seguimiento.pdf');
    Route::post('/monitoria/seguimiento/pdf/{monitor_id}/{mes}/{anio?}', [MonitoriaController::class, 'generarPDFSeguimiento'])->name('monitoria.seguimiento.pdf.post');
